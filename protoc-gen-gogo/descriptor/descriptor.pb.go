...
type FileOptions struct {
	...
	// Should generic m_services be generated in each language?  "Generic" m_services
	// are not specific to any particular RPC system.  They are generated by the
	// main code generators in each language (without additional plugins).
	// Generic m_services were the only kind of service generation supported by
	// early versions of google.protobuf.
	//
	// Generic m_services are now considered deprecated in favor of using plugins
	// that generate code specific to your particular RPC system.  Therefore,
	// these default to false.  Old code which depends on generic m_services should
...
type ServiceOptions struct {
	...
	// this is a formalization for deprecating m_services.
