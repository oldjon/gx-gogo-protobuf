...
func (m *UserMessage) Scan(src interface{}) error {
	if p == nil {
	...
	case nil:
		return nil
	default:
		return fmt.Errorf("incompatible type for UserMessage %T", v)
	}
	return m.Unmarshal(source)
}
func (m *UserMessage) Value() (driver.Value, error) {
	return m.Marshal()
}
...
func (m *LoudMessage) Scan(src interface{}) error {
	if p == nil {
		return errors.New("LoudMessage is nil")
	}
	var source []byte
	switch v := src.(type) {
	case []byte:
	...
	case nil:
		return nil
	default:
		return fmt.Errorf("incompatible type for LoudMessage %T", v)
	}
	return m.Unmarshal(source)
}
func (m *LoudMessage) Value() (driver.Value, error) {
	return m.Marshal()
}
...
func (m *LoginMessage) Scan(src interface{}) error {
	if p == nil {
		return errors.New("LoginMessage is nil")
	}
	var source []byte
	switch v := src.(type) {
	case []byte:
	...
	case nil:
		return nil
	default:
		return fmt.Errorf("incompatible type for LoginMessage %T", v)
	}
	return m.Unmarshal(source)
}
func (m *LoginMessage) Value() (driver.Value, error) {
	return m.Marshal()
}
...
func (m *Detail) Scan(src interface{}) error {
	if p == nil {
	...
	case nil:
		return nil
	default:
		return fmt.Errorf("incompatible type for Detail %T", v)
	}
	return m.Unmarshal(source)
}
func (m *Detail) Value() (driver.Value, error) {
	return m.Marshal()
}
...
func (m *Announcement) Scan(src interface{}) error {
	if p == nil {
		return errors.New("Announcement is nil")
	}
	var source []byte
	switch v := src.(type) {
	case []byte:
	...
	case nil:
		return nil
	default:
		return fmt.Errorf("incompatible type for Announcement %T", v)
	}
	return m.Unmarshal(source)
}
func (m *Announcement) Value() (driver.Value, error) {
	return m.Marshal()
}
...
func (m *OldStyleParcel) Scan(src interface{}) error {
	if p == nil {
		return errors.New("OldStyleParcel is nil")
	}
	var source []byte
	switch v := src.(type) {
	case []byte:
	...
	case nil:
		return nil
	default:
		return fmt.Errorf("incompatible type for OldStyleParcel %T", v)
	}
	return m.Unmarshal(source)
}
func (m *OldStyleParcel) Value() (driver.Value, error) {
	return m.Marshal()
}
