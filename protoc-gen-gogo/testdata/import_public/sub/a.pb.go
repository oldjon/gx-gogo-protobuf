...
func (m *M) Scan(src interface{}) error {
	...
	case nil:
		return nil
	default:
		return fmt.Errorf("incompatible type for M %T", v)
	}
...
func (m *M_Grouping) Scan(src interface{}) error {
	if p == nil {
		return errors.New("M_Grouping is nil")
	}
	var source []byte
	switch v := src.(type) {
	case []byte:
	...
	case nil:
		return nil
	default:
		return fmt.Errorf("incompatible type for M_Grouping %T", v)
	}
	return m.Unmarshal(source)
}
func (m *M_Grouping) Value() (driver.Value, error) {
	return m.Marshal()
}
...
func (m *M_Submessage) Scan(src interface{}) error {
	if p == nil {
		return errors.New("M_Submessage is nil")
	}
	var source []byte
	switch v := src.(type) {
	case []byte:
	...
	case nil:
		return nil
	default:
		return fmt.Errorf("incompatible type for M_Submessage %T", v)
	}
	return m.Unmarshal(source)
}
func (m *M_Submessage) Value() (driver.Value, error) {
	return m.Marshal()
}
