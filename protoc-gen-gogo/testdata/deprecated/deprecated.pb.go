...
// package deprecated contains only deprecated messages and m_services.
...
func (m *DeprecatedRequest) Scan(src interface{}) error {
	if p == nil {
		return errors.New("DeprecatedRequest is nil")
	}
	var source []byte
	switch v := src.(type) {
	case []byte:
	...
	case nil:
		return nil
	default:
		return fmt.Errorf("incompatible type for DeprecatedRequest %T", v)
	}
	return m.Unmarshal(source)
}
func (m *DeprecatedRequest) Value() (driver.Value, error) {
	return m.Marshal()
}
...
func (m *DeprecatedResponse) Scan(src interface{}) error {
	if p == nil {
		return errors.New("DeprecatedResponse is nil")
	}
	var source []byte
	switch v := src.(type) {
	case []byte:
	...
	case nil:
		return nil
	default:
		return fmt.Errorf("incompatible type for DeprecatedResponse %T", v)
	}
	return m.Unmarshal(source)
}
func (m *DeprecatedResponse) Value() (driver.Value, error) {
	return m.Marshal()
}
