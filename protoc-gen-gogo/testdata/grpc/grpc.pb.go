...
func (m *SimpleRequest) Scan(src interface{}) error {
	if p == nil {
		return errors.New("SimpleRequest is nil")
	}
	var source []byte
	switch v := src.(type) {
	case []byte:
	...
	case nil:
		return nil
	default:
		return fmt.Errorf("incompatible type for SimpleRequest %T", v)
	}
	return m.Unmarshal(source)
}
func (m *SimpleRequest) Value() (driver.Value, error) {
	return m.Marshal()
}
...
func (m *SimpleResponse) Scan(src interface{}) error {
	if p == nil {
		return errors.New("SimpleResponse is nil")
	}
	var source []byte
	switch v := src.(type) {
	case []byte:
	...
	case nil:
		return nil
	default:
		return fmt.Errorf("incompatible type for SimpleResponse %T", v)
	}
	return m.Unmarshal(source)
}
func (m *SimpleResponse) Value() (driver.Value, error) {
	return m.Marshal()
}
...
func (m *StreamMsg) Scan(src interface{}) error {
	if p == nil {
		return errors.New("StreamMsg is nil")
	}
	var source []byte
	switch v := src.(type) {
	case []byte:
	...
	case nil:
		return nil
	default:
		return fmt.Errorf("incompatible type for StreamMsg %T", v)
	}
	return m.Unmarshal(source)
}
func (m *StreamMsg) Value() (driver.Value, error) {
	return m.Marshal()
}
...
func (m *StreamMsg2) Scan(src interface{}) error {
	if p == nil {
		return errors.New("StreamMsg2 is nil")
	}
	var source []byte
	switch v := src.(type) {
	case []byte:
	...
	case nil:
		return nil
	default:
		return fmt.Errorf("incompatible type for StreamMsg2 %T", v)
	}
	return m.Unmarshal(source)
}
func (m *StreamMsg2) Value() (driver.Value, error) {
	return m.Marshal()
}
