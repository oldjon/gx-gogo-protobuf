...
func (m *BaseMessage) Scan(src interface{}) error {
	if p == nil {
		return errors.New("BaseMessage is nil")
	}
	var source []byte
	switch v := src.(type) {
	case []byte:
	...
	case nil:
		return nil
	default:
		return fmt.Errorf("incompatible type for BaseMessage %T", v)
	}
	return m.Unmarshal(source)
}
func (m *BaseMessage) Value() (driver.Value, error) {
	return m.Marshal()
}
...
func (m *OldStyleMessage) Scan(src interface{}) error {
	if p == nil {
		return errors.New("OldStyleMessage is nil")
	}
	var source []byte
	switch v := src.(type) {
	case []byte:
	...
	case nil:
		return nil
	default:
		return fmt.Errorf("incompatible type for OldStyleMessage %T", v)
	}
	return m.Unmarshal(source)
}
func (m *OldStyleMessage) Value() (driver.Value, error) {
	return m.Marshal()
}
