...
func (m *Simple3) Scan(src interface{}) error {
	if m == nil {
		return errors.New("Simple3 is nil")
	}
	var source []byte
	switch v := src.(type) {
	case []byte:
	...
	case nil:
		return nil
	default:
		return fmt.Errorf("incompatible type for Simple3 %T", v)
	}
	return m.Unmarshal(source)
}

func (m *Simple3) Value() (driver.Value, error) {
	return m.Marshal()
}
...
func (m *SimpleSlice3) Scan(src interface{}) error {
	if m == nil {
		return errors.New("SimpleSlice3 is nil")
	}
	var source []byte
	switch v := src.(type) {
	case []byte:
	...
	case nil:
		return nil
	default:
		return fmt.Errorf("incompatible type for SimpleSlice3 %T", v)
	}
	return m.Unmarshal(source)
}

func (m *SimpleSlice3) Value() (driver.Value, error) {
	return m.Marshal()
}
...
func (m *SimpleMap3) Scan(src interface{}) error {
	if m == nil {
		return errors.New("SimpleMap3 is nil")
	}
	var source []byte
	switch v := src.(type) {
	case []byte:
	...
	case nil:
		return nil
	default:
		return fmt.Errorf("incompatible type for SimpleMap3 %T", v)
	}
	return m.Unmarshal(source)
}

func (m *SimpleMap3) Value() (driver.Value, error) {
	return m.Marshal()
}
...
func (m *SimpleNull3) Scan(src interface{}) error {
	if m == nil {
		return errors.New("SimpleNull3 is nil")
	}
	var source []byte
	switch v := src.(type) {
	case []byte:
	...
	case nil:
		return nil
	default:
		return fmt.Errorf("incompatible type for SimpleNull3 %T", v)
	}
	return m.Unmarshal(source)
}

func (m *SimpleNull3) Value() (driver.Value, error) {
	return m.Marshal()
}
...
func (m *Mappy) Scan(src interface{}) error {
	if m == nil {
		return errors.New("Mappy is nil")
	}
	var source []byte
	switch v := src.(type) {
	case []byte:
	...
	case nil:
		return nil
	default:
		return fmt.Errorf("incompatible type for Mappy %T", v)
	}
	return m.Unmarshal(source)
}

func (m *Mappy) Value() (driver.Value, error) {
	return m.Marshal()
}
