...
func (m *Message) Scan(src interface{}) error {
	...
	case nil:
		return nil
	default:
		return fmt.Errorf("incompatible type for Message %T", v)
	}
...
func (m *Nested) Scan(src interface{}) error {
	if m == nil {
		return errors.New("Nested is nil")
	}
	var source []byte
	switch v := src.(type) {
	case []byte:
	...
	case nil:
		return nil
	default:
		return fmt.Errorf("incompatible type for Nested %T", v)
	}
	return m.Unmarshal(source)
}

func (m *Nested) Value() (driver.Value, error) {
	return m.Marshal()
}
...
func (m *IntMap) Scan(src interface{}) error {
	if m == nil {
		return errors.New("IntMap is nil")
	}
	var source []byte
	switch v := src.(type) {
	case []byte:
	...
	case nil:
		return nil
	default:
		return fmt.Errorf("incompatible type for IntMap %T", v)
	}
	return m.Unmarshal(source)
}
...
func (m *IntMaps) Scan(src interface{}) error {
	if m == nil {
		return errors.New("IntMaps is nil")
	}
	var source []byte
	switch v := src.(type) {
	case []byte:
	...
	case nil:
		return nil
	default:
		return fmt.Errorf("incompatible type for IntMaps %T", v)
	}
	return m.Unmarshal(source)
}

func (m *IntMaps) Value() (driver.Value, error) {
	return m.Marshal()
}
