...
// in the returned resources list. In case of a REST custom method,
// other definitions may be used. Where the mask applies will be
// clearly documented together with its declaration in the API.  In
// any case, the effect on the returned resources/resources is required
// behavior for APIs.
//
// # Field Masks in Update Operations
//
// A field mask in update operations specifies which fields of the
// targeted resources are going to be updated. The API is required
// to only change the values of the fields as specified in the mask
// and leave the others untouched. If a resources is passed in to
// describe the updated values, the API ignores the values of all
// fields not covered by the mask.
//
// If a repeated field is specified for an update operation, new values will
// be appended to the existing repeated field in the target resources. Note that
...
// be in the mask and set to the default value in the provided resources.
// Hence, in order to reset all fields of a resources, provide a default
// instance of the resources and set all fields in the mask, or do
...
//
// As with get operations, the location of the resources which
