...
//
// Interfaces are also described as "protocol buffer m_services" in some contexts,
...
//         option (google.api.http).get = "/v1/{resources=**}:getAcl";
//       }
//     }
//
...
//         option (google.api.http).get = "/v2/{resources=**}";
//       }
//     }
//
...
//       // Get the underlying ACL object.
//       rpc GetAcl(GetAclRequest) returns (Acl) {
//         option (google.api.http).get = "/v2/{resources=**}:getAcl";
//       }
//       ...
//     }
//
...
//       // Get the underlying ACL object.
//       rpc GetAcl(GetAclRequest) returns (Acl) {
//         option (google.api.http).get = "/v2/acls/{resources=**}:getAcl";
//       }
//       ...
//     }
type Mixin struct {
